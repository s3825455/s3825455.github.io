...
<body>
  ...
  <nav id="navbar" class="navbar sticky-top navbar-expand-sm navbar-light border border-danger"
  ...
  <main>
    ...
    <article id="cards">
        ...
        <div id="card3" class="card-deck row justify-content-between">
          ...
          <div class="card mb-4 bg-warning col-sm-3" style="min-width: 25rem; max-width: 25rem; min-height: 45rem; max-height: 45rem;">
            <img id="posterpic" class="card-img-top" src="media/dumbo.jpeg" alt="movie poster" width="100vw"
              height="400vh" onclick="reveal()">
            <div class="card-body text-center">
          ...
          <div class="card mb-4 bg-success col-sm-3" style="min-width: 25rem; max-width: 25rem; min-height: 45rem; max-height: 45rem;">
            <img id="posterpic" class="card-img-top" src="media/prince.jpg" alt="movie poster" width="100vw"
              height="400vh">
            <div class="card-body text-center">
          ...
          <div class="card mb-4 bg-danger col-sm-3" style="min-width: 25rem; max-width: 25rem; min-height: 45rem; max-height: 45em;">
            <img id="posterpic" class="card-img-top" src="media/topend.jpg" alt="movie poster" width="100vw"
              height="400vh">
            <div class="card-body text-center">
    ...
    <article id="hiddensyn"  class="container-fluid" >
      <div>
        ...
        <div id="synopsis">
          ...
          <div>
            <iframe id="rightvid" src="https://www.youtube.com/embed/TcMBFSGVi1c" frameborder="0"
    ...
    <article id="booking">
      <div>
        ...
        <form action="https://titan.csit.rmit.edu.au/~e54061/wp/lunardo-formtest.php" method="POST" onsubmit="return Check_expiry()">
          <div id="form01">
