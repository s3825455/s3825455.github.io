                    ...
                    <div class="container summary-box p-2">
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="cust[name]" id="cust-name" aria-describedby="name field" placeholder="Enter name">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="cust[address]" id="cust-address" placeholder="address">
                            </div>
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                <label class="form-check-label" for="exampleCheck1">Confirm purchase</label>
                            </div>
